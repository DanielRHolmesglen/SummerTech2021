...
Shader "Unlit/Outline" {
    Properties {
        ...
        _Ramp ("Ramp", 2D) = "white" {}
        _node_1653 ("node_1653", Float ) = 0.05
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
