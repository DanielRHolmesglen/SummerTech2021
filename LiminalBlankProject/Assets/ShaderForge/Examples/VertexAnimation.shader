    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_3528 = _Time;
                float node_133 = pow((abs((frac((o.uv0+node_3528.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape); // Panning gradient
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_3528 = _Time;
                float node_133 = pow((abs((frac((i.uv0+node_3528.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape); // Panning gradient
...
////// Emissive:
                ...
                float node_8608 = 0.1;
                float3 finalColor = emissive + lerp(_Diffuse_var.rgb,float3(node_8608,node_8608,node_8608),node_133);
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = v.texcoord0;
                o.normalDir = UnityObjectToWorldNormal(v.normal);
                float4 node_1594 = _Time;
                float node_133 = pow((abs((frac((o.uv0+node_1594.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape); // Panning gradient
                float node_1924 = node_133;
                v.vertex.xyz += (node_1924*_BulgeScale*v.normal);
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 node_1594 = _Time;
                float node_133 = pow((abs((frac((i.uv0+node_1594.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape); // Panning gradient
                float node_1924 = node_133;
